...
const KEYWORDS: Record<string, string[]> = {
  ...
  rendimentos: ['rendimento', 'dividendo', 'jcp', 'juros', 'provento', 'cashback', 'rendimento poupanca'],
  reembolso: ['reembolso', 'estorno', 'devolucao', 'ressarcimento'],
  'renda-fixa': ['cdb', 'tesouro', 'selic', 'lci', 'lca', 'poupanca', 'renda fixa', 'cri', 'cra', 'debenture', 'lft', 'ntnb', 'ipca+'],
